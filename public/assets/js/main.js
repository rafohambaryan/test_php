                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $.each(obj, function (i, item) {
                            content = content.split(i).join(item);
                        })
                        content = content.split('%URL').join(window.location.origin + '/');
                        res = window.JSON.parse(content);
                        // if (!window.sessionStorage.getItem(url)) {
                        //     window.sessionStorage.setItem(url, window.btoa(window.JSON.stringify(res)))
                        // }
                        $('body').html($(res.data))
